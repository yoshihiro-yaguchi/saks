...
import { PRODUCT_PATHS } from "../router/router"

export const Update = () => {
  const urlParams = useParams<ParamParseKey<typeof PRODUCT_PATHS.UPDATE>>()
  ...
  const state = useAppSelector((s: RootState) => s.updateProduct)
        ...
        <Box>
          <LinedContainerBox>
            <Box sx={{ display: "flex", justifyContent: "flex-end" }}>
              <Button
                variant="contained"
                onClick={() => dispatch(operations.doUpdate(navigate))}
              >
                更新する
              </Button>
            </Box>
